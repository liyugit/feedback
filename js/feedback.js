...
window.Feedback = function( options ) {
    ...
    returnMethods = {
        ...
        open: function() {
            ...
            nextButton.className =  "g-feedback-btn";
    ...
    button.className = "g-feedback-btn feedback-bottom-right";
...
window.Feedback.Screenshot.prototype.start = function( modal, modalHeader, modalFooter, nextButton ) {
    ...
    if ( this.h2cDone ) {
        ...
        for (var i = 0; i < 2; i++ ) {
            buttonItem[ i ].className = 'g-feedback-btn g-feedback-btn-small ' + (i === 0 ? 'active' : 'g-feedback-btn-inverse');
